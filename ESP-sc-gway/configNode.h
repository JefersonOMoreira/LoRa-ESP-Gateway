...
#define _DESCRIPTION "ESP32 Gateway Smart"			// Name of the gateway
#define _EMAIL "smartcampus@facens.com"		// Owner
#define _PLATFORM "ESP32"
#define _LAT -23.4708058
#define _LON -47.4286427
#define _ALT 644								// Altitude
